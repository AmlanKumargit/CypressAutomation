class Homep {
  ...
  getDropdwn() {
    return cy.get(
      "#address-ui-widgets-addr-details-address-type-and-business-hours > .a-button-inner > .a-button-text"
    );
  }
  getBestSellers() {
  ...
  getColleaguecard() {
    return cy.get(
      'img[src="https://images-eu.ssl-images-amazon.com/images/I/4157mnyJiKL.jpg"'
    );
  }
  getCart() {
