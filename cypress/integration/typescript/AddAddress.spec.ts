...
describe("Amazon", function () {
  ...
  it("Login_Add-new-address", function () {
    ...
    cy.get("#address-ui-widgets-enterAddressFullName").type("Amlan dummy", {
      force: true,
    });
    ...
    cy.get("#address-ui-widgets-enterAddressLine1").type(
      "Olive Nest, BTM 6th, Arekere"
    );
    ...
    ).select("KARNATAKA", { force: true });
    cy.get("#address-ui-widgets-use-as-my-default")
      .check({ force: true })
      .should("be.checked");
